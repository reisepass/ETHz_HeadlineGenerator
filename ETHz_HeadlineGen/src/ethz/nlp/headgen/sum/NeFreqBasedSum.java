...
public class NeFreqBasedSum extends FirstSentSum implements Summerizer {
	...
	/*
	 * Currently i just look for the sentence which as the most of the top ranking name entities 
	 * 		Currently not accounting for ties
	 * Not sure how many of the top NE we want to include. 
	 * 
	 * 
	 * 		Ok if i were to collect all the sentences that have atleast 2 of the top NE. How would i choose the best
	 * 			????
	 */
	...
	/*
	 * So at the moment this class simply returns the sentence which has the most NE in which are also in the TOP_MOST_FRequent NE list.
	 * I noticed that several sentences tend to tie for first place. So we should have a better way of choosing among those
	 * Maybe we could even construct one sentence out of several of the top sentences.
	 * 
	 * 
	 * 
	 * 
